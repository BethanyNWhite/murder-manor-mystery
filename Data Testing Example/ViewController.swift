...
class ViewController: UIViewController {
    ...
    let characterNameArray = ["Anna WeatherBee", "Benjamin Topaz", "Helen Borden", "KatnGrange", "Merida Evernever", "Lili Felton", "Toni Blossom", "Camila Weatherbee",  "Tori Blossom", "Fred Borden", "Elsa Parkinson"]
